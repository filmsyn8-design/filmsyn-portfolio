      ...
      <nav className="fixed top-0 w-full z-50 bg-slate-950/80 backdrop-blur-sm border-b border-slate-800">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-slate-900 border-t border-slate-800">
            <div className="px-6 py-4 flex flex-col gap-4 text-sm tracking-wide">
              <a href="#work" onClick={() => setIsMenuOpen(false)} className="hover:text-amber-400">WORK</a>
              <a href="#about" onClick={() => setIsMenuOpen(false)} className="hover:text-amber-400">ABOUT</a>
              <a href="#contact" onClick={() => setIsMenuOpen(false)} className="hover:text-amber-400">CONTACT</a>
            </div>
          </div>
        )}
      </nav>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-20">
            <div className="relative aspect-video rounded-lg overflow-hidden shadow-2xl border border-slate-800 group">
              <iframe
                src="https://vimeo.com/user77136150"
